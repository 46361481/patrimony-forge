...
export const MechanismsSection = () => {
  const mechanisms = [{
    ...
    description: "Reduzir de 30 para 7 anos o caminho para independência financeira absoluta."
  }, {
    icon: DollarSign,
    number: "#2",
    ...
    description: "Usar imóveis para multiplicação patrimonial acelerada, sem vender ou alugar."
  }];
  return <section className="py-16 md:py-24 px-4 bg-card">
      <div className="container mx-auto max-w-6xl">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-6 text-card-foreground">Nos dias 01, 02 e 03 de dezembro</h2>
        <p className="text-2xl md:text-3xl text-center text-green-primary font-bold mb-16">
          Rhuan Christo revelará:
        </p>

        <div className="grid md:grid-cols-3 gap-8">
          {mechanisms.map((mechanism, index) => <div key={index} className="p-8 rounded-2xl bg-background border border-gray-200 hover:border-green-primary/40 hover:shadow-lg transition-all duration-300 animate-slide-up" style={{
