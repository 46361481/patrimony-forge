      ...
      <div className="container mx-auto max-w-7xl relative z-10 py-4 md:py-8 px-4 w-full">
        ...
        <div className="max-w-3xl mb-8">
          ...
          <div className="animate-slide-up">
            ...
            <p className="text-lg md:text-xl text-gray-100 leading-relaxed mb-8">Domine os 3 mecanismos de alavancagem  que transformaram profissionais de alta  renda em investidores com renda passiva de R$ 30 mil/mês em 7 anos sem depender de sorte, timing de mercado ou aumentar seu capital inicial.</p>
