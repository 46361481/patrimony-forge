      ...
      <div className="container mx-auto max-w-7xl relative z-10 py-4 md:py-8 px-4 w-full">
        ...
        <div className="max-w-3xl mb-8">
          ...
          <div className="animate-slide-up">
            ...
            {/* CTA Button */}
            <Button variant="cta" size="xl" className="max-w-xl w-full mb-4 animate-pulse-green text-base md:text-lg font-bold pagtrust-funnel-next-step" onClick={() => document.getElementById('inscricao')?.scrollIntoView({
            behavior: 'smooth'
          })}>
